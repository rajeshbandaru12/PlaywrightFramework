//Logging Levels:
 /*DEBUG – Detailed information used during development and debugging; usually not enabled in production.
INFO – General information about application or test progress.
WARN (WARNING) – Indicates a potential issue that does not stop execution but needs attention.
ERROR – Represents a failure or issue that affects functionality and requires action.
FATAL (CRITICAL) – The highest severity level, indicating a serious failure that may terminate the application.
